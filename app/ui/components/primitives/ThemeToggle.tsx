...
/**
 * Theme toggle component for AMMY Archives.
 * Sliding thumb between sun/moon icons.
 * Uses Zustand store for theme state persistence.
 */
  ...
  return (
    ...
    >
      ...
      <div className="theme-toggle-track relative z-10">
        <div className={`centered transition-all duration-500 ${!isDark ? 'text-accent scale-100 rotate-0' : 'text-muted dim scale-75 -rotate-12'}`}>
          <Sun size={iconSize} strokeWidth={2.5} />
        </div>
        <div className={`centered transition-all duration-500 ${isDark ? 'text-white scale-100 rotate-0' : 'text-muted dim scale-75 rotate-12'}`}>
