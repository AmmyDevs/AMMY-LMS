  ...
  return (
    <footer className="page-section overflow-hidden">
      ...
      <div className="page-container grid-fourths gap-row">
        ...
        {/* Brand column */}
        <div className="col gap-block md:col-span-1 lg:col-span-2"> 
        ...
        {/* Product links */}
        <div className="col gap-[var(--space-6)]">
      ...
      {/* Bottom bar */}
      <div className="page-container mt-[var(--space-16)] pt-[var(--space-6)] border-top">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-[var(--space-4)] text-caption color-muted">
